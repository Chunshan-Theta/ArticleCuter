...
def load_model():
  models = [i for i in os.listdir() if i.endswith(".cw")]
  load_model = {}
...
def interface_convolution(model, sent: str, threshold=0.5, min_windows_size=3, max_windows_size=9, return_score=False):
